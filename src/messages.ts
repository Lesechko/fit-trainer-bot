...
// Video management
export const ADDVIDEO_USAGE = '⚠️ Використай так: /addvideo <день> <file_id> [daily|reference]\nПриклад: /addvideo 5 BAACAgI... daily\nПриклад: /addvideo 1 BAACAgI... reference\n\nПримітка: День має бути додатнім числом. Тип за замовчуванням: "daily". Використай "reference" для hard/easy відео (вони не будуть надсилатись автоматично, лише за ID).';
...
/addvideo <день> <file_id> — додати відео до дня (перезаписує, якщо вже існує)
...
*Примітка про hard/easy відео:*
Для днів з вибором складності додай hard/easy відео окремо (можна використати будь-який день), отримай їх ID через /listvideos та вкажи easyVideoId/hardVideoId у конфігурації курсу.
