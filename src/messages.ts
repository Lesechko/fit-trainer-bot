...
// Video management
export const ADDVIDEO_USAGE = '⚠️ Використай так: /addvideo <день> <file_id> [daily|reference]\nПриклад: /addvideo 5 BAACAgI...\nПриклад: /addvideo 1 BAACAgI... reference (примусово)\n\nПримітка: Тип визначається автоматично: якщо день є в конфігурації курсу → "daily", інакше → "reference". Можна вказати тип вручну для перевизначення.';
...
/addvideo <день> <file_id> [daily|reference] — додати відео (тип визначається автоматично)
...
- Тип визначається автоматично: якщо день є в конфігурації курсу → "daily" (надсилається автоматично), інакше → "reference" (лише за ID)
- Для hard/easy відео додай їх як reference (використай будь-який день), отримай ID через /listvideos та вкажи easyVideoId/hardVideoId у конфігурації курсу
